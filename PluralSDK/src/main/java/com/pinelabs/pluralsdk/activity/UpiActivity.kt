...
class UpiActivity : AppCompatActivity() {
    ...
    fun payUsingUpi(amount: String, upiId: String, name: String, note: String) {
        ...
        val uri = Uri.parse("upi://pay").buildUpon()
            .appendQueryParameter("pa", "pinelabs.24092@hdfcbank")
            .appendQueryParameter("pn", name)
            .appendQueryParameter("tn", note)
            .appendQueryParameter("am", amount)
            .appendQueryParameter("cu", "INR")
            .appendQueryParameter("tr", "ABC"+Random.nextInt().toString())
            .build()

        /*val uri = getUPIString("address","payeename", "mcc","123", "12345", "note",
            "1234.00", "INR", "")*/
